...
_Linked HashMap_ extends _HashMap_ and adds a doubly linked list to maintain the insertion order of the entries. This means that the order in which elements are added is preserved during iteration.
